...
const DEFAULT_CONFIG: Required<Pick<GradualBlurProps, 'position' | 'strength' | 'height' | 'divCount' | 'exponential' | 'zIndex' | 'animated' | 'duration' | 'easing' | 'opacity' | 'curve' | 'responsive' | 'target' | 'className' | 'style'>> = {
  position: 'bottom',
  strength: 2,
  height: '6rem',
  divCount: 5,
